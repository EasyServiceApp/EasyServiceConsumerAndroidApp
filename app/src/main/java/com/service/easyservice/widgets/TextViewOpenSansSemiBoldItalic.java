...
public class TextViewOpenSansSemiBoldItalic extends TextView implements Constants{

	String fontPath = F_OPEN_SANS_SEMI_BOLD_ITALIC;
	...
	public TextViewOpenSansSemiBoldItalic(Context context, AttributeSet attrs, int defStyle)
	{
