...
public class TextViewOpenSansLightItalic extends TextView implements Constants{

	String fontPath = F_OPEN_SANS_LIGHT_ITALIC;
	...
	public TextViewOpenSansLightItalic(Context context, AttributeSet attrs, int defStyle)
	{
