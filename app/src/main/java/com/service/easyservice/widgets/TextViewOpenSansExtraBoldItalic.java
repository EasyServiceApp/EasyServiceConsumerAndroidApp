...
public class TextViewOpenSansExtraBoldItalic extends TextView implements Constants{

	String fontPath = F_OPEN_SANS_EXTRA_BOLD_ITALIC;
	...
	public TextViewOpenSansExtraBoldItalic(Context context, AttributeSet attrs, int defStyle)
	{
