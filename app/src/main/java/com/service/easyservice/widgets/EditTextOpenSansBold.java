...
public class EditTextOpenSansBold extends TextView implements Constants {

    String fontPath = F_OPEN_SANS_BOLD;
    ...
    public EditTextOpenSansBold(Context context, AttributeSet attrs, int defStyle) {
