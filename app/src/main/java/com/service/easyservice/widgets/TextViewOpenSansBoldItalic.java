...
public class TextViewOpenSansBoldItalic extends TextView implements Constants{

	String fontPath = F_OPEN_SANS_BOLD_ITALIC;
	...
	public TextViewOpenSansBoldItalic(Context context, AttributeSet attrs, int defStyle)
	{
